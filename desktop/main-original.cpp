...
//		- [x Allow users to reset the properties of a shape?
//			- [x] Name
//			- [x] Position
//			- [x] Velocity
//			- [x] Colour
...
//		- [x] The only file that needs to be submitted is main.cpp
//		everything necessary, so refactor the project to have all custom
//		.cpp and .h code in main.cpp
//		- [x] Write the full names of all team members at the top of the main.cpp file
